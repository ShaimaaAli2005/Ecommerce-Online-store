      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-[#E5E7EB] dark:border-gray-700 p-6 space-y-4">
          ...
          <div>
            ...
            <button
              type="button"
              className="bg-[#17233C] hover:bg-[#E89A5B] text-white text-xs font-semibold px-6 py-2.5 rounded-xl transition-all duration-300 flex items-center gap-1.5 cursor-pointer shadow-sm"
            >
